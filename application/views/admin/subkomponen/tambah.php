                ...
                <div class="row">
                    <div class="col-xl">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="<?= base_url('admin/subkomponen/tambah') ?>" id="form-tambah" method="POST" enctype="multipart/form-data">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-control" name="id_komponen">
                                            ...
                                            <?php foreach ($komponen as $komp) : ?>
                                                <option value="<?= $komp['id_komponen']; ?>"><?= $komp['komponen']; ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="subkomponen" name="subkomponen" placeholder="Contoh : Pengukuran Kinerja telah dilakukan" />
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control" id="bobot" name="bobot" placeholder="Contoh : 70" onchange="setTwoNumberDecimal" min="0" max="100" step="0.5" />
