        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="row">
                    ...
                    <div class="col-xl">
                        <div class="card mb-4">
                            <form action="<?= base_url('admin/instansi/edit/') ?><?= $users['id_u']; ?>" id="form-tambah" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="profil" role="tabpanel" aria-labelledby="profil-tab">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nama_user" name="nama_user" placeholder="" value="<?= $users['nama_user'] ?>" readonly />
                                            ...
                                            <a href="<?= base_url() . 'admin/instansi' ?>" class="btn btn-secondary"><i class='bx bx-arrow-back'></i>&nbsp;&nbsp;Kembali</a>
                                            <button type="submit" class="btn btn-primary"><i class='bx bx-save'></i>&nbsp;&nbsp;Simpan</button>
                            </form>
                        </div>
                        <div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
                            <form action="<?= base_url('admin/instansi/editpass/') ?><?= $users['id_u']; ?>" id="form-tambah" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="id_u" id="id_u" value="<?= $users['id_u']; ?>" />
