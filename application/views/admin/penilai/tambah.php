                ...
                <div class="row">
                    <div class="col-xl">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="<?= base_url('admin/penilai/tambah') ?>" id="form-tambah" method="POST" enctype="multipart/form-data">
                                    <div class="form-group mb-3">
                                        <label class="form-label" for="nama_user">Nama Lengkap</label>
                                        <input type="text" class="form-control" id="nama_user" name="nama_user" placeholder="Contoh : Nur Hada" />
                                        <?= form_error('nama_user', '<small class="text-danger">', '</small>'); ?>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label class="form-label" for="usernme">Username</label>
                                        <input type="text" class="form-control" id="username" name="username" placeholder="Contoh : nrhda_" />
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <option type="Penilai" class="form-control"> Penilai</option>
                                    </div>
