    ...
    <div class="layout-page">
        ...
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <form action="<?= base_url('instansi/myprofile/editprofile/' . $this->session->userdata('id_u')); ?>" id="form-tambah" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="password" role="tabpanel" aria-labelledby="password-tab">
                                        <form action="<?= base_url('instansi/myprofile/editpass/') ?><?= $users['id_u']; ?>" id="form-tambah" method="POST" enctype="multipart/form-data">
                                            <input type="hidden" name="id_u" id="id_u" value="<?= $users['id_u']; ?>" />
